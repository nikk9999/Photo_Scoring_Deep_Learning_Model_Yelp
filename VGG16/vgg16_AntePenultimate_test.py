...
print(vgg16_feature_list_np1.shape)
# kmeans = KMeans(n_clusters=2, random_state=0).fit(vgg16_feature_list_np)
df1 = pd.read_csv('Final_Test_Nov29.csv')
